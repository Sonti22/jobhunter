...
#
# Английский C1 — из profile.yaml (languages.en.level = C1_plus), поэтому
# анти-фабрикация гейт пропускает: заявляем ровно то, что подтверждено
# профилем, и на полступени ниже исходного C2 — как и в резюме.
FORMAT_LINE = "Формат — только удалённый (страна не важна), английский C1."
...
FORMAT_LINE_EN = "Remote-only, please — any country works for me. English: C1."
