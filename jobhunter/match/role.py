...
ROLE_PATTERNS: dict[str, list[tuple[re.Pattern, float]]] = {
    ...
    "nonit": [
        (_rx(r"\bhr\b\s*(?:manager|generalist)", r"рекрут", r"маркетолог",
             ...
             # только с начала слова: «руководитель», «производительность»
             r"логист", r"\bdriver\b", r"(?<![а-яё])водител",
             ...
             r"разнорабоч", r"грузчик", r"охранник", r"кладовщик", r"уборщи",
             r"сварщик", r"монтажник", r"комплектовщик", r"упаковщик", r"курьер",
             r"вахтов\w*\s+метод", r"\bповар\b", r"официант", r"кассир",
             r"продавец", r"строительн\w*[^.\n]{0,40}работ"), 3.0),
    ],
}
